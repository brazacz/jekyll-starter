...
2. Either follow this step-by-step [tutorial](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll) or you can simply copy [this repository](https://github.com/brazacz/jekyll-starter) to your GitHub account by ![Fork](https://raw.githubusercontent.com/brazacz/svg-icons/main/src/github-fork.svg) [Fork button](https://github.com/brazacz/jekyll-starter/fork).
3. As soon as you fork this repository to your account, you can find source code of your website here: `https://github.com/<YourUserName>/jekyll-starter` and final websites located here: `https://<YourUserName>.github.io/jekyll-starter`. Please replace `<YourUserName>` with your own GitHub user name (e.g. mine is "brazacz")
4. Customize your websites to your needs. Configure your websites by changing `_config.yml`, edit the main page with `index.md` and edit the about page by changing `about.md`. To edit these files, find them in GitHub (e.g. `https://github.com/<YourUserName>/jekyll-starter/_config.yml`), click ![Edit](https://raw.githubusercontent.com/brazacz/svg-icons/main/src/github-edit.svg) Edit, make your changes and ![Commit](https://raw.githubusercontent.com/brazacz/svg-icons/main/src/github-commit.svg) Commit (save) the changes. If you want to create posts, please folow this [tutorial](https://jekyllrb.com/docs/posts/). If you want to work with data files, use this [tutorial](https://jekyllrb.com/docs/datafiles/). See more information in [Jekyll documentation](https://jekyllrb.com/docs/)
